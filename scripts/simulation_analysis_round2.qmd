...
## Known propensities, no $\pi(\hat{y})$ projection, no residualization, $\hat{y}$ as XBCF covariates
...
## Estimated propensities, no $\pi(\hat{y})$ projection, no residualization, $\hat{y}$ as XBCF covariates
...
## Known propensities, no $\pi(\hat{y})$ projection, residualization, $\hat{y}$ as XBCF covariates
...
## Estimated propensities, no $\pi(\hat{y})$ projection, residualization, $\hat{y}$ as XBCF covariates
...
## Estimated propensities, no $\pi(\hat{y})$ projection, no residualization, no $\hat{y}$ XBCF as covariates
...
## Estimated propensities, no $\pi(\hat{y})$ projection, residualization, no $\hat{y}$ XBCF as covariates
